                                ...
                                data.map((item,key) => {
                                    ...
                                    return (
                                      <tr key={key} className={styles.tr}>
                                          ...
                                          {/* <td className={styles.td} data-column={config.header[col+2]}> */}
                                              {/* { config.actions.map((action,actionkey) => <span key={actionkey} className={styles.action} onClick={() => trigger(action,item)}>{action.fn}</span>)} */}
                                          {/* </td> */}
                                      </tr>
                                    );
                                  })
